...
public class ArkIdTest {
    ...
    public void testGetSlashArk() {
        assertEquals(String.format("%s/%s", NAAN, NAME),
                arkIdFromNaanNameVersion.getSlashArk());
    }
    ...
    public void testToStringUsesGetFullArk() {
        assertEquals(arkIdFromNaanNameVersion.getFullArk(),
                arkIdFromNaanNameVersion.toString());
    }

    @Test
    @DisplayName("hashCode is consistent")
    public void testHashCode() {
        assertEquals(800436924,
                arkIdFromNaanNameVersion.hashCode());
    }

    @Test
    @DisplayName("hashCode is consistent No Version")
    public void testHashCodeNoVersion() {
        assertEquals(448828900,
                arkIdFromNaanNameOnly.hashCode());
    }
