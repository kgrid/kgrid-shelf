...
public class ArkIdTest {
    ...
    public void testCompareTo() {
        assertAll(
                () -> assertEquals(0,
                        arkIdFromNaanNameVersion.compareTo(arkIdFromNaanNameVersion)),
                () -> assertEquals(0,
                        arkIdFromNaanNameVersion.compareTo(new ArkId(NAAN, NAME, VERSION_1))),
                () -> assertTrue(0 <
                        arkIdFromNaanNameVersion.compareTo(new ArkId("banana", NAME, VERSION_1))),
                () -> assertTrue(0 <
                        arkIdFromNaanNameVersion.compareTo(new ArkId(NAAN, "apple", VERSION_1))),
                () -> assertTrue(0 >
                        arkIdFromNaanNameVersion.compareTo(new ArkId(NAAN, NAME, "grape"))),
                () -> assertTrue(0 <
                        arkIdFromNaanNameVersion.compareTo(arkIdFromNaanNameOnly))
        );
    }
}
